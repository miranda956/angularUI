...
@NgModule({
    declarations: [
        AppComponent, NotfoundComponent, MydashboardComponent, RegistrationComponent, MinistatementComponent, DepositComponent, WithdrawComponent, TransferComponent, BalanceComponent
    ],
    imports: [
        AppRoutingModule,
        AppLayoutModule,
